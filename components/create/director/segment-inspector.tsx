...
export function SegmentInspector({
  ...
  return (
    <div className="rounded-[10px] border border-[#242429] bg-[#121215] p-4">
      ...
      <div className="mb-3">
        <label className="mb-1 block text-[11px] text-[#8f8f99]">Segment prompt</label>
        <textarea
          rows={3}
        ...
        />
        <label className="mb-1 mt-2 block text-[11px] text-[#8f8f99]">Negative — this segment</label>
        <textarea
          rows={2}
