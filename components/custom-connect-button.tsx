                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {dropdownOpen && (
                    <div className="absolute right-0 mt-2 w-64 max-w-[calc(100vw-2rem)] bg-zinc-900 border border-zinc-700 rounded-xl shadow-xl overflow-hidden z-[100]">
                      {/* Header */}
                      <div className="px-4 py-3 bg-gradient-to-r from-primary/15 to-primary/5 border-b border-zinc-700">
                      ...
                      <div className="p-2">
                        ...
                        {needsAuth && (
                          <button
                            ...
                            className="w-full flex items-center gap-3 px-3 py-2.5 text-left text-primary hover:bg-primary/10 rounded-lg transition-colors mb-1 disabled:opacity-50"
                          >
                            <svg
                              className="w-5 h-5"
                              fill="none"
