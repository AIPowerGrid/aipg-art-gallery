...
SHARED_AWS_ACCESS_ID=***REMOVED_AWS_ACCESS_KEY_ID***
SHARED_AWS_ACCESS_KEY=***REMOVED_AWS_SECRET***
POSTGRES_CONN_STR=postgres://aipg:***REMOVED_DB_PASSWORD***@localhost:5432/aipg_gallery?sslmode=disable
AIPG_API_KEY=***REMOVED_AIPG_API_KEY***
```
